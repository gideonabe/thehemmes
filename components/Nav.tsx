  ...
  return (
    <>
      <motion.nav 
        ...
        className={`fixed top-0 z-[100] w-full p-6 md:p-8 flex items-center justify-between transition-all duration-500 
          ${isScrolled || isMenuOpen 
            ? 'bg-cloud-dancer/60 backdrop-blur-lg py-4 md:py-5 text-hemmes-dark shadow-sm rounded-full' 
            : 'bg-transparent text-cloud-dancer'}`}
      >
        {/* --- LEFT: TOGGLE --- */}
